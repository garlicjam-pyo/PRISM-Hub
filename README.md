...
> **최신 실행 결과:** [MATLAB 재검증 진행 기록](docs/06_MATLAB_재검증_진행기록.md), [실행 가능한 평균 모델과 수치 결과](validation/2026-09-22/README.md). 역방향 ZCS 검출과 PPRC 전력수지를 수정했고 약80 A의 실제 SPS 전류 한계를 반영했습니다. 아래 2026-09-21 설계표와 PASS 기록 전체를 수정 후 검증 완료로 해석하면 안 됩니다.
